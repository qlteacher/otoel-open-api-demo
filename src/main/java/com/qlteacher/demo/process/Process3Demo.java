...
public class Process3Demo {
    ...
    public static void main(String[] args) {
        ...
        File inFile = Constant.getFile(String.format("test-%s-%s-submit.json", Constant.activityId, ConfigUtil.getConfig().getLesson().getCatalogId()));
        if(inFile.exists()) {
            ...
            File saveFile = Constant.getFile(String.format("test-%s-%s-result.json", Constant.activityId, ConfigUtil.getConfig().getLesson().getCatalogId()));
